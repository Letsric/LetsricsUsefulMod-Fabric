...
public class ChatSoundFilterScreen extends Screen {
    ...
    public ChatSoundFilterScreen() {
        super(Text.literal("Chatsoundfilter Konfiguration"));
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < ChatSound.Filters.size() ; i++) {
            drawTextWithShadow(matrices, this.textRenderer, Text.literal(ChatSound.Filters.get(i)), this.width / 2 - 100, i * 24 + 85, 0xFFFFFF);
        }
